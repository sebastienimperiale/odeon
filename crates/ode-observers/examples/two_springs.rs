//! Mortensen filter example: two-mass spring chain (N = 2, 4D state space).
//!
...
//!
//! Heavy run: the grid has (n_elÂ·p_ord + 1)â´ â 43M DOFs at the default
//! resolution.
//!
//! Outputs go to examples/output/two_springs/.
...
fn main() {
    ...
    let params = FilterParams {
        ...
        // (a cache would cost ~1.4 GB at 43M DOFs).
    ...
    filter.run_and_save(&reference, 25, PLOT_PAIRS, "examples/output/two_springs");
}
